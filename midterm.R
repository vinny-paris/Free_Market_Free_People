...
set_10_2 <- matrix(replicate(5000, rinvgauss(10, mean = 5, shape = 2)), nrow = 5000)
set_25_2 <- matrix(replicate(5000, expr = rinvgauss(25, mean = 5, shape = 2)), nrow = 5000)
set_50_2 <-matrix(replicate(5000, expr = rinvgauss(50, mean = 5, shape = 2)), nrow = 5000)
set_100_2 <- matrix(replicate(5000, expr = rinvgauss(100, mean = 5, shape = 2)), nrow = 5000)
set_500_2 <- matrix(replicate(5000, expr = rinvgauss(500, mean = 5, shape = 2)), nrow = 5000)
